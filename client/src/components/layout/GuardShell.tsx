...
const navLinks = [
  { label: 'Scan Entry', to: '/guard/scan', icon: ScanLine },
  { label: 'Visitors', to: '/guard/visitors', icon: UserCheck },
  { label: 'Gate Analytics', to: '/guard/analytics', icon: BarChart3 },
] as const;
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-5 border-b border-[hsl(var(--border))]">
        <div className="flex items-center gap-2.5">
          <motion.div
            className="w-9 h-9 rounded-lg bg-emerald-600 flex items-center justify-center shadow-sm shadow-emerald-500/20"
          ...
          return (
            ...
            >
              ...
              >
                {isActive && (
                  <motion.div
                    layoutId="guard-sidebar-active"
                    className="absolute inset-0 rounded-xl bg-emerald-600 dark:bg-emerald-500"
                    transition={spring}
                    style={{ zIndex: 0 }}
                  />
                )}
        ...
        {user && (
          <div className="flex items-center gap-2.5 px-1">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] text-[hsl(var(--muted-foreground))]">Security Guard</p>
            </div>
          </div>
        )}
